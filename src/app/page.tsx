              ...
              <SignIn 
                ...
                appearance={{
                  ...
                  elements: {
                    ...
                    formButtonPrimary: "w-full bg-white hover:bg-gray-100 text-white font-semibold py-3 sm:py-4 px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200 border-0 text-base sm:text-lg [&>*]:text-white [&>span]:text-white [&>div]:text-white",
